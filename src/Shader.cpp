...
void Shader::SetUniformMat4fv(const std::string& name, int size, const glm::mat4* matrices)
{
    GLCall(glUniformMatrix4fv(GetUniformLocation(name), size, GL_FALSE, &matrices[0][0][0]));
}
